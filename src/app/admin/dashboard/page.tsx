...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { label: "Bugunun Ziyaretcileri", value: stats.todayVisitors, color: "text-blue-500", bg: "from-blue-500/20 to-blue-600/10" },
    { label: "Toplam Tiklanma", value: stats.totalClicks || 0, color: "text-purple-500", bg: "from-purple-500/20 to-purple-600/10" },
  ];

  const clickStats = [
    { label: "Sponsor Tiklamalari", value: stats.sponsorClicks || 0, icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
    { label: "Banner Tiklamalari", value: stats.bannerClicks || 0, icon: "M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" },
    { label: "Etkinlik Tiklamalari", value: stats.eventClicks || 0, icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
    { label: "Popup Tiklamalari", value: stats.popupClicks || 0, icon: "M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" },
  ];
    ...
    <AdminLayout>
      <div className="p-4 md:p-6">
        <div className="mb-6">
          ...
          <p className="text-[var(--text-muted)] text-sm">Site istatistiklerine genel bakis</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4">
            <h2 className="text-lg font-semibold text-white mb-4">En Cok Tiklanan Sponsorlar</h2>
                ...
                {topSponsors.map((sponsor, index) => (
                  <div key={sponsor.id} className="flex items-center justify-between p-3 bg-[var(--background)] rounded-lg">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-[var(--text-muted)]">tiklanma</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          {/* Top Banners */}
          <div className="bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4">
            <h2 className="text-lg font-semibold text-white mb-4">En Cok Tiklanan Bannerlar</h2>
            {topBanners.length > 0 ? (
              <div className="space-y-3">
        ...
        <div className="mt-6 bg-[var(--surface)] border border-[var(--border)] rounded-xl p-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            <a href="/admin/livestreams" className="p-4 bg-[var(--background)] rounded-lg hover:bg-[var(--surface-hover)] transition-colors text-center">
              ...
              <p className="text-sm text-white font-medium">Yayin Ekle</p>
            </a>
          </div>
        </div>
      </div>
