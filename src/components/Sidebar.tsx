    ...
    <aside className="hidden lg:flex flex-col w-64 min-h-screen pt-20 pb-6 px-4 border-r border-[var(--border)] bg-[var(--surface)]">
      ...
      <div className="mt-4 pt-4 border-t border-[var(--border)]">
        <div className="px-4 py-3">
          <p className="text-xs text-[var(--text-muted)] uppercase tracking-wider mb-3">Hizli Erisim</p>
          <Link href="/admin" className="flex items-center gap-2 text-sm text-[var(--text-muted)] hover:text-white transition-colors">
